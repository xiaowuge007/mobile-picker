(function () {
    ...
    function Picker(option) {
        if(option.el){
            this.el = option.el instanceof HTMLElement?option.el :document.querySelector(option.el);
        }
        this.isMove = false;
        ...
        function touchEvent(e) {
            ...
            if (type === 'touchstart') {
                ...
                obj.max_h = -(self.selectGroup[index].num - 4) * obj.li_h;
    ...
    Picker.prototype.commonCreate = function (option) {
        ...
        this.data.forEach(function (val, index) {
            ...
            pickerItems.style[transformProperty] = 'translate3d(' + 0 + 'px,' + parseInt(liHight * 3) + 'px,' + 0 + 'px)';
